...
<div class="content">
    ...
    <div class="workplace">
        ...
        <div class="row-fluid none" id="campign_form">
            <div class="span12">
                <div class="head">
                ...
                <div class="block-fluid"> 
                    <form id="campaignform" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row-form">
                            ...
                            <div class="span9"><textarea name="description" id="description"><?php echo set_value('description',isset($campigndata)?$campigndata->description:''); ?></textarea></div>
                            <div class="clear"></div>
                        </div>
                        <div class="row-form">
                             <div class="span3">Imagen camapaña:</div>
                        ...
                        <div class="row-form">
                            ...
                            <div class="span7">
                                <select  id="cap_type" name="cap_type">
                                    ...
                                    <option value="1" <?php echo (isset($campigndata)&&$campigndata->cap_type==1)?"selected":""?>>Visualizaciones</option>
                                    <option value="2" <?php echo (isset($campigndata)&&$campigndata->cap_type==2)?"selected":""?>>Clicks</option>
                                    <option value="3" <?php echo (isset($campigndata)&&$campigndata->cap_type==3)?"selected":""?>>Fecha de vencimiento</option>
                                </select>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <div class="row-form" id="wrap_qty">
                            <div class="span3 tt" title="Cantidad de cobro sea por visualizacion o por clicks">Cantidad de tipo cobro</div>
                        ...
                        <div class="row-form">
                            ...
                            <div class="span5">
                                ...
                                <label class="checkbox inline " >
                                    <div class="checker">
                                        <span class="checked">
                                            <input type="checkbox" name="filter2[]" value="<?php echo $filters[$i]->id?>" <?php echo isset($filter[$filters[$i]->id])?'checked':''?> style="opacity: 0;">
                                        </span>
                                    </div>
                        ...
                        <div id="cap_survey" <?php if(isset($campigndata)&&$campigndata->campaing_type!=34) {?>class="none"<?php }?>>
                            <div class="row-form">
                           ...
                           <div class="row-form">
                                ...
                                <div class="span9" id="add_answers">
                                    <input type="text" class="answer" id="add_answer" name="add_answer" placeholder="Respuesta" value=""/>
