$(document).ready(function(){
    ...
    if($("#chart-3").length > 0){        
        var data = [];
		data[0] = { label: "Recurrente", data: 65 };
		data[1] = { label: "Nuevos", data: 35 };
    ...
    if($("#chart-3A").length > 0){
        var data = [];
		data[0] = { label: "Masculino", data: 45, color: "#6FC954" };
		data[1] = { label: "Femenino", data: 55, color: "#ED7B00" };	
